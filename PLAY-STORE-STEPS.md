...
4. **Play Console** (one-time $25): listing (title, descriptions, 2+ phone screenshots, 512 icon, 1024x500 feature graphic), privacy policy URL (required — a ready-made [`privacy.html`](privacy.html) is included; host it next to the app and use `https://<your-domain>/privacy.html`), content rating + data safety forms.
