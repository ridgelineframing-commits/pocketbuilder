...
const CACHE='pocketbuilder-v14';
const ASSETS=['./','./index.html','./styles.css','./js/engine.js','./js/app.js','./js/share.js','./js/edit-ops.js','./js/scale.js','./js/desktop.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
